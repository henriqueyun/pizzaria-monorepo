...
module.exports = {
  ...
  async down (queryInterface, Sequelize) {
    ...
    await queryInterface.sequelize.query(`DELETE usuarios`);
    await queryInterface.sequelize.query(`DELETE pizzas`);
    await queryInterface.sequelize.query(`DELETE bebidas`);
  }
};
